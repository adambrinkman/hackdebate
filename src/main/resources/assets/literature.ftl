                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                <div class="col-sm-10">
                                    <p class="lead"><strong>Topic: </strong><small><em>Does reading literature make you more moral?</em></p></small>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div id="textbook" class="col-sm-12" style="margin-top: 10px;">
                                    ...
                                    <ul>
                                        <li>
                                            <base><em><span class="txtName">Best Practices in Literacy Instruction</span>, <span class="txtAuthor"> Lesley Mandel Morrow </span>, ISBN: <span class="txtIsbn"> 978-1609181789</span></em></base>
                                        </li>
                                        <li>
                                            <base><em><span class="txtName">Literary Education and Digital Learning</span>, <span class="txtAuthor">    Willie van Peer</span>, ISBN: <span class="txtIsbn">000-1605669326</span></em></base>
                                        </li>
                                    </ul>
